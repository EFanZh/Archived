(function () {
    ...
    function num_to_full_hex_color(num) {
    ...
    function num_to_hex_color(num) {
        var c = num_to_color(num);
        if(c.r % 0x11 === 0 && c.g % 0x11 === 0 && c.b % 0x11 === 0) {
            return [
                (c.r / 0x11).toString(16), 
                (c.g / 0x11).toString(16), 
                (c.b / 0x11).toString(16)
            ].join("");
        }
        function get_hex_value(n) {
            var s = n.toString(16);
            if(n < 0x10) {
                return [
                    "0", 
